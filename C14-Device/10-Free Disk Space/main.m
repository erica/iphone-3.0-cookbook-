...
- (void) action: (UIBarButtonItem *) bbi
{
	...
	[self doLog:@"System space: %@", [self commasForNumber:[[fattributes objectForKey:NSFileSystemSize] longLongValue]]];
	[self doLog:@"System free space: %@", [self commasForNumber:[[fattributes objectForKey:NSFileSystemFreeSize] longLongValue]]];
}
